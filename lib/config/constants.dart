...
void validateInput(String? value, BuildContext context) {
...
DateTime parseDateStringFromApi(String dateString) {
  ...
  try {
    ...
    print("parsedDate ${DateTime(parsedDate.year, parsedDate.month, parsedDate.day)}");
