...
class ProjectMilestoneBloc extends Bloc<ProjectMilestoneEvent, ProjectMilestoneState> {
  ...
  ProjectMilestoneBloc() : super(ProjectMilestoneInitial()) {
    ...
    on<DeleteProjectMilestone>(_onDeleteProjectMilestone);
    on<SearchProjectMilestone>(_onSearchProjectMilestone);
    on<ProjectMilestoneCreated>(_onCreateMilestoneProject);
    on<UpdateMilestoneProject>(_onUpdateProjectMilestone);
  }
  ...
  void _onDeleteProjectMilestone(
  ...
  Future<void> _onCreateMilestoneProject(ProjectMilestoneCreated event,
