class Autogenerated {
  ...
  String? message;
  int? total;
  List<CandidateInterviewsModel>? data;
  ...
  Autogenerated.fromJson(Map<String, dynamic> json) {
    ...
    total = json['total'];
    if (json['data'] != null) {
      data = <CandidateInterviewsModel>[];
      json['data'].forEach((v) {
        data!.add(new CandidateInterviewsModel.fromJson(v));
      });
    }
...
class CandidateInterviewsModel {
  int? id;
  String? name;
  String? email;
  String? phone;
  ...
  CandidateInterviewsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    phone = json['phone'];
