          ...
          child: Row(
            ...
            children: [
              if (context.read<PermissionsBloc>().isManageTask == true)
                _tabItem(HeroIcons.documentChartBar, "Sub Task",
                    AppColors.orangeColor, 0),
              ...
              if (context.read<PermissionsBloc>().isManageActivityLog == true)
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            ...
                                            context.read<TaskMediaBloc>().add(
                                                TaskStartDownload(
                                                    fileUrl: media.file,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        print("gklr dlgknv ");
                        context.read<TaskMediaBloc>().add(UploadTaskMedia(
                            id: widget.id!,
