                  ...
                  child: Column(children: [
                    ...
                    Expanded(
                      child: RefreshIndicator(
                          ...
                          child: context.read<PermissionsBloc>().isManageTask ==
                                  true
                              ? BlocConsumer<TaskBloc, TaskState>(
                                  ...
                                  builder: (context, state) {
                                    ...
                                    if (state is TaskLoading) {
                                      ...
                                      BlocProvider.of<TaskBloc>(context)
                                          .add(TaskDashBoardFavList(isFav: 1));
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        await TaskRepo().updateTaskFavorite(
                                          id: task.id,
