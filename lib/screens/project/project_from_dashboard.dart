                ...
                child: FloatingActionButton(
                  ...
                  child: isFirstTimeUSer == true
                      ? Showcase(
                          ...
                          key: _one,
                          disposeOnTap:
                              true, // ✅ Required when using onTargetClick
        ...
        child: DismissibleCard(
          ...
          confirmDismiss: (DismissDirection direction) async {
            ...
            if (direction == DismissDirection.endToStart) {
              try {
                ...
                return false;
              } // Default to false if dialog is dismissed without action
            }
          ...
          onDismissed: (DismissDirection direction) {
            if (direction == DismissDirection.endToStart &&
                context.read<PermissionsBloc>().isdeleteProject == true) {
              // setState(() {
              //   print("vyghujnkm current id ${stateProject[index].id}");
              //   // project.removeAt(index);
              //   // print("prev ${stateProject[index].id}");
              //   _onDeleteProject(stateProject[index].id);
              // });
              WidgetsBinding.instance.addPostFrameCallback((_) {
                setState(() {
                  stateProject.removeAt(index);
          ...
          dismissWidget: InkWell(
            onTap: () {
              router.push('/projectdetails', extra: {
                ...
                "from": "dashboard",
                "projectModel": stateProject[index]
              });
            },
            child: Container(
              // height: 250.h,
