  ...
  void _onAddProjectMileStone(){
    if (titleController.text.isNotEmpty &&
      ...
      context.read<ProjectMilestoneBloc>().add(ProjectMilestoneCreated(
        ...
        cost: budgetController.text.isNotEmpty?budgetController.text:"",
      ));
    } else {
      flutterToastCustom(
        msg: AppLocalizations.of(context)!.pleasefilltherequiredfield,
                  ...
                  titlestartend: AppLocalizations.of(context)!.selectstartenddate,
                    ...
                    onTap: (start, end) {
                      setState(() {
                        ...
                        startsController.text = "${dateFormatConfirmed(selectedDateStarts, context)} <-> ${dateFormatConfirmed(selectedDateEnds!, context)}";
