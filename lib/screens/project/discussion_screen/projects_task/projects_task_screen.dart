...
class ProjectTaskScreen extends StatefulWidget {
  final int? id;
  const ProjectTaskScreen({super.key, this.id});
...
class _ProjectTaskScreenState extends State<ProjectTaskScreen>
  ...
  void initState() {
    BlocProvider.of<TaskBloc>(context)
        .add(AllTaskListOnTask(projectId: [widget.id!]));
    super.initState();
    getIsFirst();
  }
  ...
  Widget build(BuildContext context) {
    ...
    print(" ehsfhidsh ${context.read<PermissionsBloc>().iscreatetask}");
                    ...
                    children: <Widget>[
                      ...
                      InkWell(
                          onTap: () {
                            ...
                            BlocProvider.of<TaskBloc>(context).add(
                                AllTaskListOnTask(projectId: [widget.id!]));
  ...
  Widget _listOfProject(task, isLightTheme, date, statetask, index, taskModel) {
    print("flisgjiu ${context.read<PermissionsBloc>().iseditTask}");
    return Padding(
        ...
        child: DismissibleCard(
          ...
          confirmDismiss: (DismissDirection direction) async {
            ...
            if (direction == DismissDirection.endToStart) {
              ...
              print("Swipe startToEnd detected — navigating to /notification");
