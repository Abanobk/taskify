...
Widget detailMenu(
    ...
    required key,
    required context,
    required onpressEdit,
    required onpressDelete,
    onpressdiscuss,
    onpressChat}) {
  return ExpandableFab(
    ...
    distance: isChat
        ...
        : isDiscuss
            ? 80.w
            : 60.w, // Distance from the main FAB to its children

// Distance from the main FAB to its children

    // type: ExpandableFabType.fan,
    type: !isChat ? ExpandableFabType.up : ExpandableFabType.fan,
    fanAngle: 100,
    ...
    children: [
      ...
      isChat == true
          ? FloatingActionButton.small(
              tooltip: AppLocalizations.of(context)!.discussion,
              backgroundColor: Color(0xffb5e2b5),
              heroTag: CustomText(
