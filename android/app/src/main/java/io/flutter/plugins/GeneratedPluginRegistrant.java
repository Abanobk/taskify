...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new jp.espresso3389.content_resolver.ContentResolverPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin content_resolver, jp.espresso3389.content_resolver.ContentResolverPlugin", e);
    }
    try {
